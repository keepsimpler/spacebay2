...
class BuyerBookedSpaceCalendarReport extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            ...
            <AccountReport title="Booked Space Calendar"
                           getReportDataUrl={(account) => `api/buyer-space-utilization/${account.id}`}
...
export default BuyerBookedSpaceCalendarReport;
